...
public class Varias {
   ...
   * devuelve el segmento correspondiente.
   * <p>
   ...
   * @return       segmento de número compuesto por todos los dígitos que van desde
   *               la posición inicial a la posición final incluyendo ambos
   */
  public static long segmentoDeNumero(long x, int inicio, int fin) {
   ...
   *               la posición inicial a la posición final incluyendo ambos
   */
  public static int segmentoDeNumero(int x, int inicio, int fin) {
    return (int)segmentoDeNumero((long)x, inicio, fin);
  }

  /**
   * Pega dos números para formar uno solo.
   *
   * @param x segmento que se pegará por la izquierda
   * @param y segmento que se pegará por la derecha
   * @return  número compuesto de los segmentos <code>x</code> e <code>y</code>
   */
