...
public class EjerciciosFunciones01 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Al 78604000 le quito el segmento que va de la posición "
        + "0 a la 3: " + Varias.segmentoDeNumero(78604000, 0, 3));
    System.out.println("Al 78604000 le quito el segmento que va de la posición "
        + "4 a la 6: " + Varias.segmentoDeNumero(78604000, 4, 6));
    System.out.println("Al 78604000 le quito el segmento que va de la posición "
        + "2 a la 2: " + Varias.segmentoDeNumero(78604000, 2, 2));
